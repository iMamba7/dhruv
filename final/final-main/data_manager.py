...
class data_manager:
    ...
    def calculatePaisaUsingTotalItem(cursor,date : int ,name : str , box : int,dazon : int , total_item : int , option_input : int, company : str):
        ...
        cursor.execute('''
            INSERT INTO data (id, date, name, box, dozen, total_items, price, total_price)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
            ''', (company,date, name, box, dazon , total_item, option_input, total_paisa))
    ...
    def calculateWieghtUsingDozenToTotalItem(cursor,date : int ,name : str , box : int,dazon : int , option_input : int, company : str):
        ...
        cursor.execute('''
            INSERT INTO data (id, date, name, box, dozen, total_items, weight, total_weight)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
            ''', (company ,date, name, box, dazon , total_item, option_input, total_weight))
    ...
    def calculateBothUsingDozenTOTotalItem(cursor,date : int ,name : str , box : int,dazon : int  , option_input : int , both : int, company : str):
        ...
        cursor.execute('''
        INSERT INTO data (id, date, name, box, dozen,total_items,weight,total_weight, price, total_price)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?,?,?)
        ''', (company,date, name, box, dazon ,total_item,both,total_wieght, option_input, total_paisa))
    ...
    def calculateBothUsingTotalitem(cursor,date : int ,name : str , box : int,dazon : int ,total_item : int, option_input : int,both : int, company : str):
        ...
        cursor.execute('''
            INSERT INTO data (id, date, name, box, dozen, total_items,weight,total_weight, price, total_price)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ''', (company,date, name, box, dazon , total_item,both,total_weight, option_input, total_paisa))
    ...
    def get_company_data(selection,company):
        ...
        curson = conn.cursor()
        if selection == "weight":
            query = "SELECT date, name, box, dozen, total_items, weight, total_weight FROM data WHERE id = ?"
        else:
            query = "SELECT date, name, box, dozen, total_items, price, total_price FROM data WHERE id = ?"
